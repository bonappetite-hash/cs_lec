...
CREATE TABLE siblings AS
  SELECT a.child AS first_child, b.child AS second_child, c.size AS size
  FROM parents a, parents b, size_of_dogs c, size_of_dogs d
...
CREATE TABLE low_variance AS
  SELECT fur, 
  MAX(height) - MIN(height) AS range
  FROM dogs 
  GROUP BY fur
