...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if num_factors(score) <= 2 or num_factors(score) > 4:
        return score
    else:
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def strategy(current_player,oppoent_player):
        return n
    return strategy 
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    current_score, oppoent_score = 0, 0
    rolls = strategy(current_score, oppoent_score)
    for i in range(goal+1):
        for j in range(goal): 
            current_score, oppoent_score = current_score , j
            rerolls = strategy(current_score, oppoent_score)
            if rerolls != rolls:
                return False
        current_score, oppoent_score = i, 0
    return True 
    # END PROBLEM 7
